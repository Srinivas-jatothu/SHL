...
# def save_to_csv(job_data, filepath):
#     with open(filepath, 'w', newline='', encoding='utf-8') as csvfile:
#         fieldnames = ['Job Name', 'URL', 'Description', 'Job Levels', 'Languages', 'Assessment Length', 'Test Type', 'Remote Testing', 'Downloads']
...
# Example job data to test saving to CSV
job_solutions = [
    {
        'Job Name': 'Account Manager Solution',
        'URL': 'https://service.shl.com/docs/Fact Sheet Account Manager One Sitting_USE.pdf',
        'Description': 'An assessment for mid-level leadership positions...',
        'PDF Link': 'https://service.shl.com/docs/Fact Sheet Account Manager One Sitting_USE.pdf',
        'PDF Content': 'PDF content goes here...',
        'Languages': 'English (USA)',
        'Remote Testing': 'Yes',
        'Job Levels': 'Mid-Professional',
        'Test Type': 'C, P, A, B',
        'Assessment Length': '49 minutes'
    }
]

# Save the data
save_to_csv(job_solutions, "job_solutions.csv")
